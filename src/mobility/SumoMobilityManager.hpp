...
private:
    ...
    std::shared_ptr<MobilityManagerData> executeUpdate(const SumoUpdater::Results&, ObjectContainer_ptr, std::shared_ptr<Action>);
    void addVehicle(const std::string&, MobilityManagerData*, ObjectContainer_ptr);
